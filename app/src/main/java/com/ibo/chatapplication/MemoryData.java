...
public final class MemoryData {
    ...
    public static String getData(Context context){
        String data="";
        try {
            FileInputStream fis = new FileInputStream("datata.txt");
    ...
    public static String getName(Context context){
        String data="";
        try {
            FileInputStream fis = new FileInputStream("nameee.txt");
            InputStreamReader isr = new InputStreamReader(fis);
            BufferedReader bufferedReader = new BufferedReader(isr);
            StringBuilder sb = new StringBuilder();
            String line;
    ...
    public static String getLastMsgTS(Context context,String chatId){
        String data="0";
        try {
            FileInputStream fis = new FileInputStream(chatId+".txt");
            InputStreamReader isr = new InputStreamReader(fis);
            BufferedReader bufferedReader = new BufferedReader(isr);
            StringBuilder sb = new StringBuilder();
            String line;
